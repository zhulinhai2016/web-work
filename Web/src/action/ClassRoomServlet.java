...
public class ClassRoomServlet extends HttpServlet {
    ...
    public void updateClassRoom(String classRoomId,String ip) throws JSONException{
    	JSONObject o = new JSONObject();
    	boolean flag = Updatter.updateIp(classRoomId, ip,null,null);
    	if(flag){
	    	o.put("result", 1);
	    	o.put("msg", "操作成功");
    	}else{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			this.updateClassRoom(getPm("classRoomId"),getPm("ip"));
