...
//        	return func.apply(self, args || []);
        	var paramS = func.apply(self, args || []);
        	if(!args[0] || !args[0].limit){
        		return paramS;
        	}else{
        		paramS.limit=args[0].limit;
//        		paramS.offset=parseInt(args[0].offset)-parseInt(args[0].limit);
        		paramS.offset=args[0].offset;
        		return paramS;
        	}
        }
...
//        console.log(this.options.sidePagination);
        if (this.options.sidePagination === 'server') {
            this.options.totalRows = data[this.options.totalField];
            fixedScroll = data.fixedScroll;
//            console.log(this.options.dataField);
