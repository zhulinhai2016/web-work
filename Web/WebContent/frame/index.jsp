...
<script src="${pageContext.request.contextPath}/public/js/nav-item.js" type="text/javascript" charset="utf-8"></script>
<style type="text/css">
a {
...
.m-fTop-item a.nav_a {
    ...
    .m-fTop-item a.nav_a:hover{
		...
		*{list-style:none; margin:0; padding:0;}
		...
		#li{ list-style-type:none; width:200px; height:50px;
		     text-align:center;background:lightblue;
		
		}
		#nav_menu .nav_menu { height:30px; line-height:30px; font-size:15px; background-color: #1E9FFF; }
		 
		#nav_menu .nav_menu li { float:left; position:relative;} /*这一级是导航*/
		#nav_menu .nav_menu li a { display:block; line-height:50px; text-decoration:none; padding:0px 20px; color:rgba(255,255,255,.8);font-size: 16px;   }
		#nav_menu .nav_menu li a:hover {  background:#2689d4; color:white;}
		#nav_menu .nav_menu li a.more:after{content:" ?";}
		 
		#nav_menu .nav_menu li ul { position:absolute;   text-align:center; float:left;  border:1px solid #D2D2D2; display:none; background-color:#FFFfff; } /*这是第二级菜单*/
		#nav_menu .nav_menu li ul a { width:110px;text-decoration:none;  line-height: 36px; color:#333333;font-size: 16px; background-color:white;}
		#nav_menu .nav_menu li ul a:hover { background:#4E5465;}
		 
		#nav_menu .nav_menu li ul ul{ top:0;left:150px;} /*从第三级菜单开始,所有的子级菜单都相对偏移*/
...
<script type="text/javascript">
	...
	(function(){
		$(function(){
			$(document).on('click','.left-top .show',function(event){
				$("#menu-container").toggle(1000);
				console.log($('iframe[tab-id="page1"]'));
			});
...
<body>
	...
	<div class="m-frame-toe">
	<div class="m-frame-top">
		<div class="m-fTop-left">
			<div class="left-top">
			   <p  class="llik" ></p>
			    <p  class="lliks" style="position: relative;">北理珠教室电控系统</p>
			    <span class="show"><img alt="" src="${pageContext.request.contextPath}/images/bg-mu.png"></span>
			    
			    <!-- <span class="hide ui-icon  ui-icon-circle-triangle-w"></span> -->
				<!-- <img class="logo-title" src="public/img/nav/16.2.png" /> -->
				<!--  <img class="logo-bg" src="public/img/nav/jian.png" /> -->
			</div>
		</div>
			<div class="m-fTop-center" id="nav_menu">
			<!-- TODO11 -->
			<%
			...
			<!-- <div class="m-fTop-item m-building-del">
				<a class="nav_a" href="javascript:void(0)" onclick="showBuildDelBox()">删除大楼</a> 
				<a class="nav_a" href="javascript:void(0)" onclick="showFloorDelBox()">删除楼层</a>
			</div>
			<div class="m-fTop-item m-building-add">
				<a class="nav_a" href="javascript:void(0)" id="addBuildBtn">添加大楼</a>
				<a class="nav_a" href="javascript:void(0)" id="addFloorBtn">添加楼层</a> 
				<a class="nav_a" href="javascript:void(0)" id="addClassBtn">添加教室</a>
			</div> -->
			<%
				}
			%>
			<ul class="nav_menu" style="margin: 0;">
				<li class="up"><a href="javascript:void(0)">参数分析</a>
					<ul class="one">
						<li class="up"><a href="javascript:void(0)" class="m-home-page">主页</a></li>
						<li class="up"><a href="javascript:void(0)" class="m-editPower-page">修改功率</a></li>
						<li class="up"><a href="javascript:void(0)" class="m-rundatacount-page">运行统计</a></li>
					</ul>
				</li>
				<li class="up"><a href="javascript:void(0)">空调电闸</a>
					<ul class="one">
						<li class="up"><a href="javascript:void(0)" class="open-all-air-sw">空调闸开</a></li>
						<li class="up"><a href="javascript:void(0)" class="close-all-air-sw">空调闸关</a></li>
						
					</ul>
				</li>
				<li class="up"><a href="javascript:void(0)">总闸开关</a>
					<ul class="one">
						<li class="up"><a href="javascript:void(0)" onclick="javascript:if(confirm('您确定要全部开吗?')) headAction('openAll','');">全部开</a></li>
						<%
							if (userName== null || userName == "" || userName.equals("admin")) {
						 %>
							<li class="up"><a href="javascript:void(0)" onclick="javascript:if(confirm('您确定要全部关吗?')) headAction('closeAll','');">全部关</a></li>
						<%
							}
						%>
					</ul>
				</li>
				<li class="up"><a href="javascript:void(0)">电源管理</a>
					<ul class="one">
						<li class="up"><a href="javascript:void(0)" onclick="showBuildControlBox(1)">整栋开</a></li>
						<li class="up"><a href="javascript:void(0)" onclick="showBuildControlBox(2)">整栋关</a></li>
						<li class="up"><a href="javascript:void(0)" onclick="showFloorControlBox(1)">整层开</a></li>
						<li class="up"><a href="javascript:void(0)" onclick="showFloorControlBox(2)">整层关</a></li>
					</ul>
				</li>
				<%
				...
				if (userName== null || userName == "" || userName.equals("admin")) {
			%>
				<li class="up"><a href="javascript:void(0)">楼层管理</a>
					<ul class="one m-building-add">
						<li class="up"><a href="javascript:void(0)" id="addBuildBtn">添加大楼</a></li>
						<li class="up"><a href="javascript:void(0)" id="addFloorBtn">添加楼层</a></li>
						<li class="up"><a href="javascript:void(0)" id="addClassBtn">添加教室</a></li>
						<li class="up"><a href="javascript:void(0)" onclick="showBuildDelBox()">删除大楼</a></li>
						<li class="up"><a href="javascript:void(0)" onclick="showFloorDelBox()">删除楼层</a></li>
					</ul>
				</li>
				<%}%>
			...
			<div >
				<a href="./login/index.jsp"><img class="login-user"  src="public/img/nav/1.12.png"
					width="43">
					</a>
			</div>
				...
				<div class="tr">
					...
					<div class="td"
						...
						<div
							...
							<button
								style="min-width: 80px; color: #fff; background: #2689d4; border: 0px; padding: 5px;margin-top:28px;margin-left: 40;"
						...
						<div class="td classes-item-panel firstWindow"
							...
							<div class="clabel1">
								...
								<center>
									...
									<a onmouseout="changeImage(this,'public/img/js/8.png');"
								...
								<center>
									...
									<a onmouseout="changeImage(this,'public/img/js/9.png');"
										...
										onclick="showKeBiao('[classId]')"style="width:80px"><img
...
<script src="${pageContext.request.contextPath}/resource/js/rundatacountManage.js" type="text/javascript"charset="utf-8"></script>
